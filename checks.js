...
assert.equal(addTime(23, 0, 0), '23:00', 'При добавлении 0 мин. к 23:00 получится 23:00');
assert.equal(addTime(23, 59, 60*24), '23:59', 'При добавлении 1 суток к 23:59 получится 23:59');
assert.equal(addTime(23, 59, 60*3*24+1), '00:00', 'При добавлении 3 суток и 1 минуты к 23:59 получится 00:00');
